    ...
    >
      ...
      >
        <svg viewBox="0 0 200 200" className="rotating-svg">
          ...
          <a href="#archive" className="nav-link" onClick={(e) => handleNavClick(e, 'archive')}>
            <text 
              fill="#B4AC97" 
              fontSize="30" 
              fontWeight={activePage === 'archive' ? "700" : "400"} 
              letterSpacing="2px" 
              fontFamily="'Zen Old Mincho', serif" 
              textAnchor="middle"
              style={{ filter: activePage === 'archive' ? 'drop-shadow(0 0 5px rgba(180, 172, 151, 0.9))' : 'none' }}
            >
