      ...
      >
        <svg viewBox="0 0 200 200" className="rotating-svg">
          ...
          <a href="#projects" className="nav-link" onClick={(e) => handleNavClick(e, 'projects')}>
            <text 
              fill={activePage === 'projects' ? "#ffffff" : "#B4AC97"} 
              fontSize="30" 
              fontWeight={activePage === 'projects' ? "700" : "400"} 
              letterSpacing="2px" 
              fontFamily="'Zen Old Mincho', serif" 
              textAnchor="middle"
              style={{ filter: activePage === 'projects' ? 'drop-shadow(0 0 2px rgba(255,255,255,0.5))' : 'none' }}
            >
          ...
          <a href="#about" className="nav-link" onClick={(e) => handleNavClick(e, 'about')}>
            <text 
              fill={activePage === 'about' ? "#ffffff" : "#B4AC97"} 
              fontSize="30" 
              fontWeight={activePage === 'about' ? "700" : "400"} 
              letterSpacing="2px" 
              fontFamily="'Zen Old Mincho', serif" 
              textAnchor="middle"
              style={{ filter: activePage === 'about' ? 'drop-shadow(0 0 2px rgba(255,255,255,0.5))' : 'none' }}
            >
          ...
          <a href="#contact" className="nav-link" onClick={(e) => handleNavClick(e, 'contact')}>
            <text 
              fill={activePage === 'contact' ? "#ffffff" : "#B4AC97"} 
              fontSize="30" 
              fontWeight={activePage === 'contact' ? "700" : "400"} 
              letterSpacing="2px" 
              fontFamily="'Zen Old Mincho', serif" 
              textAnchor="middle"
              style={{ filter: activePage === 'contact' ? 'drop-shadow(0 0 2px rgba(255,255,255,0.5))' : 'none' }}
            >
